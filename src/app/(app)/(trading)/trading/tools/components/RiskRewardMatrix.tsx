  ...
  return (
    <div className="bg-white rounded-[24px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#E5E7EB] p-4 md:p-6 flex flex-col h-full">
      ...
      <div className="flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 px-3 pb-2 border-b border-[#F3F4F6] text-[10px] font-bold text-[#9CA3AF] uppercase tracking-wider">
          <div>R:R Ratio</div>
      ...
      <div className="mt-auto pt-6 border-t border-[#E5E7EB]">
        <div className="bg-[#111827] rounded-[24px] p-4 md:p-5 text-white relative overflow-hidden">
