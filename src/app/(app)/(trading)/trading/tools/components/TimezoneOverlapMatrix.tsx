...
export function TimezoneOverlapMatrix() {
  return (
    <div className="bg-[#ffffff] border border-[#E5E7EB] rounded-[24px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] overflow-hidden flex flex-col h-full md:col-span-2">
      ...
      <div className="p-6 flex flex-col gap-4 md:gap-6">
        ...
        <div className="w-full relative h-[180px] bg-[#F8FAFC] rounded-[24px] border border-[#E5E7EB] p-4 flex flex-col justify-between">
          ...
          <div className="relative flex-1 w-full">
            ...
            <div className="absolute top-22 left-[54.1%] w-[37.5%] h-8 bg-gradient-to-r from-[#ECFDF5] to-[#D1FAE5] border border-[#6EE7B7] rounded-md flex items-center px-3 shadow-[0_4px_20px_rgba(0,0,0,0.03)] group z-10" style={{ top: '88px' }}>
