  ...
  return (
    <GatedContent minPackageRequired={3} blurLevel="md" customMessage="Trading tools and calculators are exclusively available for Package 3 members. Upgrade your subscription to unlock these features.">
      <div className="flex flex-col max-w-[1400px] mx-auto w-full pb-10 pt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-4 md:p-8 items-start mb-8">
          <TimezoneOverlapMatrix />
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-4 md:p-8 items-start mb-12">
          
          {/* Left Column */}
          <div className="flex flex-col gap-4 md:gap-4 md:p-8 h-full">
