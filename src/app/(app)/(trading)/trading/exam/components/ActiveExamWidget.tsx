    ...
    <div className="bg-white rounded-[24px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#E5E7EB] p-4 md:p-6 flex flex-col mb-6">
      ...
      {!isStarted ? (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <h2 className="text-[20px] md:text-[24px] font-bold text-[#111827] mb-2">Phase 2: Quantitative Risk Engine Final Exam</h2>
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-[#1D4ED8] hover:bg-[#1E40AF] text-white px-4 md:px-8 py-3 rounded-[24px] font-bold text-[15px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] transition-colors"
          >
        ...
        <>
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-0 mb-6 pb-6 border-b border-[#F3F4F6]">
            ...
            <div className="flex flex-col items-end">
              ...
              <span className="text-[24px] md:text-[28px] font-black font-mono text-[#EF4444] leading-none">{formatTime(timeLeft)}</span>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 md:gap-6">
            <div className="bg-[#F8FAFC] border border-[#E5E7EB] rounded-lg p-4 md:p-5">
              <div className="flex gap-4">
                <span className="text-[20px] md:text-[24px] font-bold text-[#1D4ED8]">14.</span>
                <div className="flex flex-col">
