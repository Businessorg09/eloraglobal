...
export default function MarketIntelligencePage() {
  return (
    <GatedContent minPackageRequired={3} blurLevel="md" customMessage="Live Market Intelligence and Institutional Heatmaps are reserved for Package 3 Elite members. Upgrade for full global access.">
      <div className="flex flex-col mx-auto w-full pb-10 gap-6 font-sans">
        ...
        <div className="max-w-[1600px] mx-auto w-full px-4 xl:px-8 space-y-6">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 h-auto xl:h-[800px]">
            ...
            <div className="xl:col-span-8 flex flex-col h-[600px] xl:h-full">
              <div className="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-6 flex flex-col h-full overflow-hidden transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
            ...
            <div className="xl:col-span-4 flex flex-col gap-6 h-full">
              ...
              {/* Top Right: Heatmap */}
              <div className="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-6 flex flex-col h-[380px] transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
                <div className="flex items-center justify-between mb-4 shrink-0">
                  <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
              ...
              <div className="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-6 flex flex-col flex-1 min-h-[380px] transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
                <div className="flex items-center justify-between mb-4 shrink-0">
                  <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2">
