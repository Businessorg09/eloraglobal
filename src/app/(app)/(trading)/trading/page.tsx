      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
        ...
        <div className="order-2 xl:order-1 xl:col-span-12 flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-5 md:p-6 rounded-[24px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#E5E7EB]">
          ...
          <div className="flex flex-wrap items-center gap-3 mt-2 lg:mt-0">
            <button className="flex items-center gap-2 bg-[#F8FAFC] border border-[#E5E7EB] hover:bg-[#F3F4F6] text-[#4B5563] hover:text-[#111827] px-4 py-2.5 rounded-xl text-[13px] font-bold transition-colors shadow-sm">
              <span className="material-symbols-outlined text-[18px]">tune</span> Curriculum Filter
            </button>
            <a href="#command-center" className="flex items-center gap-2 bg-[#1D4ED8] hover:bg-[#1E40AF] text-white px-5 py-2.5 rounded-xl text-[13px] font-bold transition-colors shadow-sm">
