                  ...
                  <div className="flex flex-col items-center justify-center my-4">
                    <div className="relative w-44 h-44 flex items-center justify-center">
                      <svg className="w-full h-full -rotate-90" viewBox="0 0 36 36">
                        ...
                        {milestonePct > 0 && <motion.circle initial={{ strokeDasharray: "0, 100" }} animate={{ strokeDasharray: `${milestonePct}, 100` }} transition={{ duration: 1.5, delay: 1 }} cx="18" cy="18" fill="none" r="15.915" stroke="#e0e4ef" strokeDashoffset={-(binaryPct + sponsorPct + leadershipPct + rankPct)} strokeWidth={3.8} />}
                      </svg>
